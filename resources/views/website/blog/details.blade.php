...
@section('body')
    ...
    <section class="blog-hero spad set-bg" data-setbg="{{asset('/')}}website/assets/img/blog/blog-hero.jpg">
        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <a href="#" class="blog__details__option__item">
                                        ...
                                        <div class="blog__details__option__item__img">
                                            <img src="{{asset('/')}}website/assets/img/blog/prev.jpg" alt="">
                                        </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <a href="#" class="blog__details__option__item blog__details__option__item--right">
                                        ...
                                        <div class="blog__details__option__item__img">
                                            <img src="{{asset('/')}}website/assets/img/blog/next.jpg" alt="">
                                        </div>
                                        <div class="blog__details__option__item__text">
                                            <h6>Looking for Music & Sounds for my new Android...</h6>
                                            <span>Nov 27, 2019</span>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="blog__details__recent__item">
                                        <img src="{{asset('/')}}website/assets/img/blog/ri-1.jpg" alt="">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="blog__details__recent__item">
                                        <img src="{{asset('/')}}website/assets/img/blog/ri-2.jpg" alt="">
                                        <h5>What are the steps of a body lift procedure?</h5>
                                        <span>Dec 06, 2019</span>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="blog__details__recent__item">
                                        <img src="{{asset('/')}}website/assets/img/blog/ri-3.jpg" alt="">
