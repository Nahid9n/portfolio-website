            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Categories</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Category Module</a></li>
                        <li><a href="#" class="slide-item">All Category</a></li>
                        <li><a href="#" class="slide-item">Add Category</a></li>
                        <li><a href="#" class="slide-item">Category Wise Table</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Country Table</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Country Module</a></li>
                        <li><a href="#" class="slide-item">All Country</a></li>
                        <li><a href="#" class="slide-item">Add Country </a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">User Details</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="">Customer List</a></li>
                        <li><a href="#" class="slide-item">All User</a></li>

                        <li><a href="#" class="slide-item">Add New User</a></li>
                        <li><a href="#" class="slide-item">Upgraded User</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Sales Module</span>
                        <i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Sales Module</a></li>
                        <li><a href="#" class="slide-item">All Orders</a></li>
                        <li><a href="#" class="slide-item">Pending Orders</a></li>
                        <li><a href="#" class="slide-item">Complete Orders</a></li>
                        <li><a href="#" class="slide-item">Cancel Orders</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Pricing Module</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Pricing Module</a></li>
                        <li><a href="#" class="slide-item">All Pricing</a></li>
                        <li><a href="#" class="slide-item">Add Pricing</a></li>
                        <li><a href="#" class="slide-item">Invoice History</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Report Module</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Report Module</a></li>
                        <li><a href="#" class="slide-item">Stock report</a></li>
                        <li><a href="#" class="slide-item">Sales report</a></li>
                        <li><a href="#" class="slide-item">User Credits Report</a></li>
                        <li><a href="#" class="slide-item">CSV File Download Report</a></li>
                        <li><a href="#" class="slide-item">Wallet recharge history</a></li>
                        <li><a href="#" class="slide-item">Commission history</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Support Module</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Support Module</a></li>
                        <li><a href=#" class="slide-item">Product conversation</a></li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Payment Module</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li><a href="#" class="slide-item">Payment Method</a></li>
                        <li><a href="#" class="slide-item">Payment Gateway</a></li>
                    </ul>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Basic Setup</span><i class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
