...
@section('body')
        <div class="row">
            <div class="col-6 my-2">
                <p class="navbar-brand">Blog Details</p>
            </div>
            <div class="col-6 my-2">
                <a href="{{route('blogs.index')}}" class="btn btn-success">All Blog</a>
            </div>
                                ...
                                <div class="">
                                    <div class="d-sm-flex d-block align-items-center">
                                        <div class="d-flex align-items-center mb-sm-0 mb-2">
                                            ...
                                            <h6 class="mb-0 text-muted ms-2 text-13 me-sm-0 me-2">{{$blog->author}}</h6>
                                        </div>
                                    ...
                                    <div>
                                        <h3 class="font-weight-normal text-dark-light mt-4 mb-4">{{$blog->title}}</h3>
                                    </div>
                                </div>
                                <div class="ps-relative p-1 bg-light br-5">
                                    <img src="{{asset($blog->image)}}" alt="img" class="cover-image  ms-auto me-auto wp-100">
                                    <span class="badge bg-primary-gradient blog-label label5">nature</span>
                                </div>
                                <div class=" mb-2 mt-5 content">
                                    <p class="text-muted text-14 ">{!! $blog->long_description !!}</p>
                                </div>
                                ...
                                <div class="card overflow-hidden border br-5">
                                    ...
                                    <div class="card-body">
                                        <div class="text-center">
                                            <a href="blog-details.html"><img class="card-img-top w-100 w-100" src="assets/images/photos/11.jpg" alt=""></a>
                                        ...
                                        <div class="text-center demo-gallery">
                                            <div class="mt-2">
                                                <ul id="lightgallery" class="list-unstyled row row-sm">
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/blog2.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/blog2.jpg" data-sub-html="<h4>Gallery Image 1</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/blog2.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/fileimage1.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/fileimage1.jpg" data-sub-html="<h4>Gallery Image 2</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/fileimage1.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/fileimage3.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/fileimage3.jpg" data-sub-html="<h4>Gallery Image 3</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/fileimage3.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/fileimage2.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/fileimage2.jpg" data-sub-html="<h4>Gallery Image 4</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/fileimage2.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/blog2.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/blog2.jpg" data-sub-html="<h4>Gallery Image 5</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/blog2.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/fileimage4.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/fileimage4.jpg" data-sub-html="<h4>Gallery Image 6</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/fileimage4.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/fileimage1.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/fileimage1.jpg" data-sub-html="<h4>Gallery Image 7</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/fileimage1.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/fileimage2.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/fileimage2.jpg" data-sub-html="<h4>Gallery Image 8</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/fileimage2.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
                                                    <li class="col-sm-6 col-lg-4" data-responsive="https://laravel8.spruko.com/noa/assets/images/photos/fileimage3.jpg" data-src="https://laravel8.spruko.com/noa/assets/images/photos/fileimage3.jpg" data-sub-html="<h4>Gallery Image 9</h4>">
                                                        <a href="javascript:void(0)">
                                                            <img class="img-responsive br-5 w-100" src="assets/images/photos/fileimage3.jpg" alt="Thumb-1">
                                                        </a>
                                                    </li>
