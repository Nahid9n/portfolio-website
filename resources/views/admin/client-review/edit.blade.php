...
@section('title', 'Edit Client Review Page')
@section('body')
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Update Client Review</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-bottom justify-content-between">
                    ...
                    <a href="{{route('client-review.index')}}" class="btn btn-primary px-4 float-end" type="submit">All Client Review</a>
                </div>
                <div class="card-body">

                    <form class="form-horizontal" action="{{route('client-review.update',$review->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <img src="{{asset($review->image)}}" alt="" width="100">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="name" required value="{{ $review->name }}" name="name" placeholder="Enter your Service name" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control"  name="review" placeholder="Enter review" id="summernote" cols="30" rows="10">{{ $review->review }}</textarea>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="designation" value="{{ $review->designation }}" name="designation" placeholder="Enter your Meta Title" type="text">
